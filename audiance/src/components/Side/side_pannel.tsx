...
export default function Side_pannel() {
  return (
    <div className='fixed w-60 h-full flex flex-col border-b-1 border-r-1 border-gray-500 text-white'> 
        <ul className='w-60 flex font-sans flex-col px-4 text-black py-10 text-xl justify-around gap-5 '>
            <button className=' flex gap-2 flex-row rounded-[5px] text-left p-2 bg-[#f3f4f6]'>
